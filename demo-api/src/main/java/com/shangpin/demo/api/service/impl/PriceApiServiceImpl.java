...
//
//            ResponseDto<PriceResponseDto> responseDto = JsonUtil.fromJson(result, new TypeToken<ResponseDto<PriceResponseDto>>() {
//            }.getType());//TypeToken，它是gson提供的数据类型转换器，可以支持各种数据集合类型转换。
//            PriceResponseDto priceDto = responseDto != null ? responseDto.getContent() : null;
//
//            if (priceDto == null) {
